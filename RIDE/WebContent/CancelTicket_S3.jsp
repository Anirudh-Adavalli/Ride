...
try
{ 
	sts=mail.mailsend1(msg,email,"teama15mrec","gladiator");
}catch(Exception e){
...
out.println("<script>alert('Confirmation Message Sent to Mail')</script>");
	...
	System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->"+DelTicketQry);
	System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->"+UpdRouteQry);
	System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->"+DelPaymentQry);
	System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->"+DelCustQry);
